...
[ "${IPSILON_DB_OPENIDC:-}" = "" ] && IPSILON_DB_OPENIDC="ipsilon"
[ "${IPSILON_DB_OPENIDC_STATIC:-}" = "" ] && IPSILON_DB_OPENIDC_STATIC="ipsilon"
...
ipsilon-server-install \
    ...
    --openidc=yes \
    --openidc-dburi="mysql://${IPSILON_DB_USER}:${IPSILON_DB_PASS}@${IPSILON_DB_HOST}/${IPSILON_DB_OPENIDC}?ssl=true&ssl_ca=${IPSILON_DB_CA}&ssl_key=/etc/ssl/private/ipsilon.key&ssl_cert=${IPSILON_DB_CERT}" \
    --openidc-static-dburi="mysql://${IPSILON_DB_USER}:${IPSILON_DB_PASS}@${IPSILON_DB_HOST}/${IPSILON_DB_OPENIDC_STATIC}?ssl=true&ssl_ca=${IPSILON_DB_CA}&ssl_key=/etc/ssl/private/ipsilon.key&ssl_cert=${IPSILON_DB_CERT}"
